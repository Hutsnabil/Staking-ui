...
const SOCIALS = {
  discord: { icon: <FaDiscord />, link: 'https://discord.gg/FnsYQxkj' },  
  medium: { icon: <FaLink />, link: 'https://www.Crazy-Chickens.com/' },
  twitter: { icon: <FaTwitter />, link: 'https://twitter.com/CrazyChickens_' },
}
